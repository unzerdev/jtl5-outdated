...
<?php if ($transaction->getTransactionObject()->isPartialRefundPossible()):?>
	<h3><?php echo UnzerCw_Language::_('Partial Refund'); ?></h3>
	<form action="<?php $refundConfirmUrl; ?>" method="POST" class="unzercw-line-item-grid" id="refund-form">
		...
		<table class="table">
			...
			<tfoot>
				<tr>
					<td colspan="6" class="right-align"><?php echo UnzerCw_Language::_('Total Refund Amount'); ?>:</td>
		...
		<div style="text-align: right;">
			<a onclick="$('#refund-form').submit();" class="btn btn-success"><?php echo UnzerCw_Language::_('Refund'); ?> </a>
		</div>
	</form>
<?php endif;?>
