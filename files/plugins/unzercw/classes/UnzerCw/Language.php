...
class UnzerCw_Language {
	...
	public static function _($stringToTranslate, $args = array()) {
		...
		$plugin = UnzerCw_Util::getPluginObject();
		$translations = UnzerCw_VersionHelper::getInstance()->getTranslations($plugin);
		...
		return Customweb_Util_String::formatString($translatedString, $args);
	}
